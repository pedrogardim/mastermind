...
export const readRankingFromStorage = () => JSON.parse(localStorage.getItem(STORAGE_KEY) || "[]")
    .sort((a, b) => a.time - b.time)
    .slice(0, 10);
export const saveColorsToStorage = (colors) => {
    localStorage.setItem(COLORS_KEY, JSON.stringify(colors));
};
export const readColorsFromStorage = () => JSON.parse(localStorage.getItem(COLORS_KEY) || "[]");
